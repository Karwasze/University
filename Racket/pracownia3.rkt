...
(define (signature make-signed-message)
  (car make-signed-message))

(define (message make-signed-message)
  (cdr make-signed-message))

;;; Encrypting and signing a message

(define (encrypt-and-sign message recipient-public-key sender-private-key)
  (make-signed-message (car (RSA-convert-list (list (compress (RSA-encrypt message recipient-public-key))) sender-private-key))
...
(define (authenticate-and-decrypt cyphertext recipient-private-key sender-public-key)
    (if (= (compress (message cyphertext)) (car (RSA-unconvert-list (list (signature cyphertext)) sender-public-key)))
        (intlist->string (RSA-unconvert-list (message cyphertext) recipient-private-key))
        "zly podpis cyfrowy"))
...
(encrypt-and-sign "asdf" (make-key 513756253 416427023) (make-key 816898139 301956869))

(authenticate-and-decrypt '(17920075 331012497) (make-key 513756253 462557987) (make-key 816898139 180798509))